...
text_feel_2 = 'Вот список благодарностей:\n'\
...
main_menu_buttons = telebot.types.ReplyKeyboardMarkup(True).row('Новая благодарность', 'Мои благодарности').row('Получить поддержку','О практике благодарности').row(stick.insp).row('Настройки','Команда бота', 'База знаний')
...
achieve_methods = telebot.types.ReplyKeyboardMarkup(True).row('Круглое видеосообщение').row('Голосовое сообщение').row('Текстовое сообщение')
